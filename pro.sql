...
INSERT INTO `address` VALUES (1,'eastham'),(2,'illford');
...
CREATE TABLE `answer_choice` (
  `answer_choice_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `audit` (
  ...
  `audit_date` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `auditor_id` int(11) DEFAULT NULL,
  `file_attachment_type_id` int(11) DEFAULT NULL,
  `audit_status_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`audit_id`),
  KEY `company_id` (`company_id`),
  KEY `term_id` (`term_id`),
  KEY `auditor_id` (`auditor_id`),
  KEY `file_attachment_type_id` (`file_attachment_type_id`),
  ...
  CONSTRAINT `audit_ibfk_4` FOREIGN KEY (`file_attachment_type_id`) REFERENCES `file_attachment_type` (`file_attachment_type_id`),
...
INSERT INTO `audit` VALUES (1,1,1,'2023-02-09 11:34:52',2,1,3),(2,2,2,'2023-02-09 11:34:52',3,1,1);
...
CREATE TABLE `audit_answer` (
  `audit_answer_id` int(11) NOT NULL AUTO_INCREMENT,
  `audit_questions_id` int(11) DEFAULT NULL,
...
CREATE TABLE `audit_auditee` (
  `audit_auditee_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `audit_questions` (
  `audit_questions_id` int(11) NOT NULL AUTO_INCREMENT,
  `question_id` int(11) DEFAULT NULL,
  `audit_id` int(11) DEFAULT NULL,
...
CREATE TABLE `audit_results` (
  `audit_results_id` int(11) NOT NULL AUTO_INCREMENT,
  `audit_id` int(11) DEFAULT NULL,
...
CREATE TABLE `audit_status` (
  `audit_status_id` int(11) NOT NULL AUTO_INCREMENT,
  `audit_status_name` varchar(30) DEFAULT NULL,
...
INSERT INTO `audit_status` VALUES (1,'inprogress'),(2,'completed'),(3,'deferred'),(4,'scheduled');
...
INSERT INTO `category` VALUES (1,'payroll'),(2,'reporting');
...
INSERT INTO `company` VALUES (1,'BT_group',1,1,2),(2,'Tech solution',2,2,1);
...
CREATE TABLE `company_status` (
  ...
  `company_status_name` varchar(30) DEFAULT NULL,
...
INSERT INTO `company_status` VALUES (1,'BT_group'),(2,'Tech_solution');
...
CREATE TABLE `company_type` (
  ...
  `company_type_name` varchar(30) DEFAULT NULL,
...
INSERT INTO `company_type` VALUES (1,'private limited'),(2,'public limited'),(3,'sole trade');
...
INSERT INTO `designation` VALUES (1,'software developer'),(2,'key worker'),(3,'sales manager'),(4,'auidtor');
...
CREATE TABLE `file_attachment_type` (
  `file_attachment_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `file_attachment_type_name` varchar(30) DEFAULT NULL,
  `file_attachment_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`file_attachment_type_id`),
...
CREATE TABLE `immigration_status` (
  `immigration_status_id` int(11) NOT NULL AUTO_INCREMENT,
  `immigration_status_name` varchar(20) DEFAULT NULL,
...
CREATE TABLE `person` (
  ...
  CONSTRAINT `person_ibfk_2` FOREIGN KEY (`company_id`) REFERENCES `company` (`company_id`),
...
INSERT INTO `person` VALUES (1,'john',1,2,1),(2,'jack',2,1,2),(3,'mark',2,2,1);
...
INSERT INTO `term` VALUES (1,'first term'),(2,'second term'),(3,'third term'),(4,'fourth term');
...
-- Dump completed on 2023-02-09 16:24:17
